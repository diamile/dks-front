<template>
 ...
 <div class="left_coloum floatleft mt-10">
  <div class="max-w-screen-xl mx-auto  relative w-100">
    ...
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
      ...
      <a href="#" class="font-semibold inline-block">Actualité</a>
    </div>
    <a href="#">See All</a>
  </div>
      
    <div class="col-lg-6 col-md-12 p-2" v-for="x in items" :key="x">
      <div class="position-relative h-100" style="min-height: 400px; background-image: url(https://cdn.shortpixel.ai/client/q_glossy,ret_img/https://8am.af/wp-content/uploads/2020/09/GHANI.jpg); background-position: center; background-size: cover;">
        <div class="position-absolute p-3 d-flex flex-column align-items-start justify-content-end" style="background: linear-gradient(to bottom, transparent, rgba(0,0,0,1)); top:0; bottom:0; left:0; right:0;">
          <a href="#" class="text-white p-1 px-2 mb-2 bg-indigo" style="background-color: #9B5DE5;">
            ACTUALITE
          </a>
          <h3 class="h6"><a href="#" class="text-white" style="line-height: 1.6;">Dr. Abdullah Abdullah's Presidential Election Campaign</a></h3>
          <div class="mt-2">
            <a href="#" class="pl-2 text-white mr-2" style="border-left: 3px solid #CF0000;">Sara Faizi</a>
          </div>
        </div>
      </div>
</div>
