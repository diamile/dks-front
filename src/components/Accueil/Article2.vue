<template>
 <div class="left_coloum floatleft" style="margin-top:20px;">
  <div class="max-w-screen-xl mx-auto  relative w-100">
    
    <div class="bg-white border">
      <div class="border-b  flex justify-between text-sm">
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
      <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.005 455.005" style="enable-background:new 0 0 455.005 455.005;" xml:space="preserve">
      <g>
      ...
      <a href="#" class="font-semibold inline-block">Politique</a>
    </div>
    <a href="#">See All</a>
  </div>
      
  <div class="col-lg-6 col-md-12 p-2 col-sm-12" v-for="x in items" :key="x">              
   <div class="article-image relative w-full flex items-end justify-start text-left bg-cover bg-center" style="min-height: 550px;" :style="{'background-image': 'url(' + require('../../assets/images/ahmed.jpg') + ')'}">
  <div class="absolute top-0 mt-20 right-0 bottom-0 left-0 bg-gradient-to-b from-transparent to-gray-900"></div>
      <div class="absolute top-0 right-0 left-0 mx-5 mt-2 flex justify-between items-center">
        <a href="#" class="text-xs bg-indigo-600 text-white px-5 py-2 uppercase bg-indigo transition ease-in-out duration-500">Politics</a>
  ...
  <div class="card  title-people-items">

    <div class="card-header">Ahmed Khalifa Niass</div>
  <div class="card-body">
    <p class="card-text">
     Le leader du Front des alliances patriotiques (FAP), a exprimé mardi, son souhait de voir Ousmane Sonko indemne dans l’affaire dite de viol ..... 
    </p>
